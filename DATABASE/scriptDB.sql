...
CREATE INDEX `fk_OBSERVATION_USER1_idx` ON `EPS_SYSTEM`.`OBSERVATION` (`USER` ASC) VISIBLE;

CREATE INDEX `fk_OBSERVATION_REQUERIMENT1_idx` ON `EPS_SYSTEM`.`OBSERVATION` (`REQUERIMENT` ASC) VISIBLE;
