...
CREATE TABLE IF NOT EXISTS `EPS_SYSTEM`.`PROJECT` (
  ...
  `CORRECTION_Calendario` INT(11) NULL,
  `CORRECTION_Plan` INT(11) NULL,
  `CORRECTION_Anexo` INT(11) NULL,
  `CORRECTION_title` INT(11) NULL,
  `CORRECTION_objectives` INT(11) NULL,
  `CORRECTION_coordinate` INT(11) NOT NULL,
  PRIMARY KEY (`id`),
